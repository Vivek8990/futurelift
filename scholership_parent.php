  ...
  <section class="form-section" id="form-section">
    <div class="formBox">
      <div class="formContainer">
        ...
        <div class="signBox">
          <h1>parents</h1>
          <form action="functions.php?scholershipparent" class="text-center" method="post">
            <div class="form-group ">
              <div class="row ">
                ...
                <div class="col-10">
                  <input type="text" name="fathername" class="form-control" required placeholder="fathername"autocomplete="off">
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-10">
                  <input type="text" name="fatheroccupation" class="form-control" placeholder="fatheroccupation" id="job"
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-10">
                  <input type="text" name="mothername" class="form-control" placeholder="mothername" required
                    autocomplete="off">
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="row ">
                ...
                <div class="col-10">
                  <input type="text" name="motheroccupation" class="form-control" placeholder="motheroccupation" required
                    autocomplete="off">
                </div>
              </div>
            </div>
