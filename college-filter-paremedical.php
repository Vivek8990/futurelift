...
<head>
	...
	<title>future lift paramedical Colleges in india</title>
...
<body>
	...
	<section class="college_filter_page_management" id="management">
		<div class="container shadow">
			<div class="row">
				<h1 class="heading text-center">Paramedical colleges in india</h1>
								...
								<div class="filterItems ">
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											...
											<label for="" class="form-label">B.P.T. (Bachelor of Physiotherapy)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.P.T (Master of Physiotherapy)</label>
											<span>(1004)</span>
										</div>
									</div>
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.Optom (Bachelor of Optometry)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.Optom (Master of Optometry)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.P.H (Master of Public Health)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.M.L.T (Bachelor of Medical Lab Technology)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.O.T (Bachelor of Occupational Therapy)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.O.T (Master of Occupational Therapy)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.P.M.t. (Bachelor of Paramedical Technology)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.N.Y.S. (Bachelor of Naturopathy and Yogic Science)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.M.L.T. (Master of Medical Laboratory Technology)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.H.M.S. (Bachelor of Homoeopathic Medicine and Surgery)</label>
											<span>(1004)</span>
										</div>
									</div>
                                </div>
							...
							<div class="filter-body">
								...
								<div class="filterItems ">
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Physiotherapy</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Medical Lab Technology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pathology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Medical Technician</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Optometry</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Public Health</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Child Health</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Nutrition and Dietetics</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Medical radio Diagnosis</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Operation Theatre Technology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Dialysis  Technician</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Hospital Administration</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Clinical Research</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">X-Ray Technician</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Medical Imaging Technology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Critical Care Technology</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Paramedical Science</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Clinical Phycology</label>
											<span>(1004)</span>
										</div>
									</div>
								</div>
