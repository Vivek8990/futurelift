								...
								<div class="filterItems ">
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											...
											<label for="" class="form-label">M.D (Doctor of Medicine)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.B.B.S (Bachelor of Medicine and Bachelor of Surgery)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.S (Master of Surgery)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.A.M.S (Bachelor of Ayurvedic Medicine and Surgery)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M. Ch. (Master of Chirugiee)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.P.T (Master of Philosophy)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.D.S (Master of Dental Science)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">BSMS (Bachelor of Siddha Medicine and Surgery)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">MAMS (Master of Ayurvedic Medicine and Surgery) </label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">MPH (Master of Public Health)</label>
											<span>(1004)</span>
										</div>
									</div>
                                </div>
							...
							<div class="filter-body">
								...
								<div class="filterItems ">
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Obstetrics and Gynecology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Physiology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">General Medicine</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Paediatrics</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Orthopaedics</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Medical Sciences</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Ayurveda</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Anatomy</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Biochemistry</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Ophthalmology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Psychiatry</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Community Medicine</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Anesthesiology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Dermatology Venereology and Leprosy</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Anaesthesia</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Forensic Medicine</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Radiology</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Neurology</label>
											<span>(1004)</span>
										</div>
									</div>
								</div>
