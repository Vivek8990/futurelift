...
<head>
	...
	<title>future lift agriculture Colleges in india</title>
...
<body>
	...
	<section class="college_filter_page_management" id="management">
		<div class="container shadow">
			<div class="row">
				<h1 class="heading text-center">hotem management colleges in india</h1>
							...
							<div class="filter-body">
								...
								<div class="filterItems ">
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.H.M (Bachelor of Hotel Management)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
                                    ...
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.H.M.C.T (Bachelor of Hotel Management and catering Technology)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.T.T.M (Bachelor of Tourism and Travel Management)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
                                    ...
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.T.M (Master of Tourism Management)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.T.A (Master of Tourism Administration)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.H.M (Bachelor of Hospital Management)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Bachelor in Tourism and Hotel Management</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.H.A (Master of Hotel Management)</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Master of Tourism and Hotel Management</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
							...
							<div class="filter-body">
								...
								<div class="filterItems ">
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Hotel Management</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Tourism Management</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Catering Science & Hotel Management</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Hospitality Management</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Travel & Tourism Management</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Food & Beverage</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Bakery & Confectionary</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">House Keeping</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Culinary Arts</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Hotel and Catering Management </label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Event Management</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Food Production </label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Aviation</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Hotel Administration</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Tourism studies</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Front Office</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Hospitality and Hotel Administration</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
				...
				<div class="col-lg-9 col-md-12 right_side mt-5">
					...
					<div class="boxfilterDitails  shadow p-3 my-3">
						<div class="logowithDitail">
							...
							<div class="aplyButton">
								<a href="college-page.html" class="btn">aply now</a>
							</div>
						</div>
						<div class="ditail  clearfix">
							<div class="structurDitail float-start">
