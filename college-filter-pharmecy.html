...
<head>
	...
	<title>future lift pharmacy Colleges in india</title>
...
<body>
	...
	<section class="college_filter_page_management" id="management">
		<div class="container shadow">
			<div class="row">
				<h1 class="heading text-center">Pharmacy colleges in india</h1>
								...
								<div class="filterItems ">
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											...
											<label for="" class="form-label">B.Pharm (Bachelor of Pharmacy)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">M.Pharm (Master of Pharmacy)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Diploma in Pharmacy</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharm.D (Doctor of Pharmacy)</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">B.Pharm + M.B.A</label>
											<span>(1004)</span>
										</div>
									</div>
                                </div>
							...
							<div class="filter-body">
								...
								<div class="filterItems ">
									...
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmaceutics</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmacology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmaceutical Analysis</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Quality Assurance</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmaceutical Chemistry</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmacognosy</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Industrial Pharmacy</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmaceutical Management and Regulatory Affairs</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmaceutical Science</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmaceutical Chemistry and Technology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Post Baccalaureate</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Clinical Pharmacy</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmacovigilance</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Ayurveda Pharmacy</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Herbal Products</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Marine Pharmacology</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmaceutical MBA</label>
											<span>(1004)</span>
										</div>
									</div>
									<div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Pharmaceutical PGDM</label>
											<span>(1004)</span>
										</div>
									</div>
                                    <div class="filterContent">
										<div class="filterContentCheck d-flex">
											<input type="checkbox" class="form-check-input">
											<label for="" class="form-label">Veterinary Pharmacy</label>
											<span>(1004)</span>
										</div>
									</div>
								</div>
